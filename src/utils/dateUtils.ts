 ...
 */
export type ProjectWithDates = Omit<Project, 'startDate' | 'endDate' | 'createdAt' | 'updatedAt'> & {
    startDate: Date;
    endDate: Date;
    createdAt: Date;
    updatedAt: Date;
 ...
 */
export type SerializedProject = Omit<Project, 'startDate' | 'endDate' | 'createdAt' | 'updatedAt'> & {
    startDate: string;
    endDate: string;
    createdAt: string;
    updatedAt: string;
